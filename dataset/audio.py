...
class Audio(Dataset):
	...
	def __getitem__(self, idx):
		...
		mics = audio['farfield']['mics'] # parameter of microphones(locations)
		srcs = audio['farfield']['srcs'] # parameter of sources(locations)
		speed = audio['farfield']['speed'] # the speed of sound
		snrs = audio['farfield']['snr']    # the SNRs of received signals in microphones
		...
		noise = audio['farfield']['noise'] # white noise variance 
		...
		## compute the tdoas of signals of different sources for microhones 
