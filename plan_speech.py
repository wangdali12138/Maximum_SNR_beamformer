...
parser.add_argument('--root', default=r'test_audio_wav', type=str,
                    help='Root folder with all audio files')
parser.add_argument('--json', default='./json/speech.json', type=str, help='JSON with parameters')
parser.add_argument('--speech_meta', default='./meta/SPEECH_TEST.meta', type=str, help='Root folder with SPEECH META')
...
# read all audio files with 5s duration from the root directory and store result to meta file 
